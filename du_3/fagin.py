...
#print(students_ids_frame.to_list())
insert_multiple_values(student_ids, global_directory)


#print_final_structure(global_directory)


# Test insertions from the lecture
#insert_multiple_values([20, 11, 8, 27, 19, 5, 24, 32], global_directory)
